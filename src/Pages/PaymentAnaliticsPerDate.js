...
export default function PaymentAnaliticsPerDate() {
  ...
  const Currentmonth = Months[now.getMonth()];
    ...
    const fetchData=async()=>{
      ...
      setlabelSet([]);
      if(todate && fromdate){
       await axios.get(`https://stage-pilot-train-booking-system.onrender.com/booking/revenue/perdate/date/${fromdate}/${todate}`)
       .then(response=>{
    ...
    const fetchMonthlyData=async()=>{
      setdataSet([]);
      setlabelSet([]);
      await axios.get(`https://stage-pilot-train-booking-system.onrender.com/booking/revenue/perdate/monthly`)
       .then(response=>{
        const data = response.data;
            console.log(data);
            if (data) {
