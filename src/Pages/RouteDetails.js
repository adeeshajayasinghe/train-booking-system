...
export default function RouteDetails() {
  ...
  const updatehandler= async(e,index)=>{
    ...
    if(routeDetails.length>orginalData.length){
      try{
        await axios.post('https://stage-pilot-train-booking-system.onrender.com/routes/addroute',
      {
    ...
    try{
      await axios.put(`https://stage-pilot-train-booking-system.onrender.com/routes/update/${id}`,routeDetails[index])
    }
    catch(err){
      console.log(err)
    }
   ...
   setDetails(newDetails);
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const res = await axios.get(`https://stage-pilot-train-booking-system.onrender.com/routes`);
                console.log(res)
                  setDetails(res.data);
